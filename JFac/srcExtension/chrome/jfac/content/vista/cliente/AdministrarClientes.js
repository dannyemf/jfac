...
AdministrarClientes.prototype.inicializar = function () {
...
AdministrarClientes.prototype.keyBuscar = function (event) {
	if(event.keyCode == 13){
		self.buscar();
	}
};
AdministrarClientes.prototype.cmdBuscar = function () {
	self.buscar();
};

AdministrarClientes.prototype.cmdEliminar = function () {
	self.eliminar();
};

AdministrarClientes.prototype.cmdNuevo = function () {
	self.nuevo();
};

AdministrarClientes.prototype.cmdEditar = function () {
	self.editar();
};

AdministrarClientes.prototype.buscar = function () {
...
AdministrarClientes.prototype.eliminar = function () {
...
AdministrarClientes.prototype.nuevo = function () {
	var us = new Cliente();
...
AdministrarClientes.prototype.editar = function () {	
	var us = this.treeClientes.getSelected();
	if(us != null){
		var features = "chrome,modal,dependent=true,dialog,centerscreen";
		window.openDialog("chrome://jfac/content/vista/cliente/EditarCliente.xul", "ixxi", features, us);
