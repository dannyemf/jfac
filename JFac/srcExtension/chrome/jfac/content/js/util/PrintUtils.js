...
var PrintUtils = {
  ...
  enterPrintPreview: function (aWindow)
  {
    ...
    printPreviewTB = document.createElementNS(XUL_NS, "printpreviewtoolbar");
  
    printPreviewTB.setAttribute("printpreview", true);
    printPreviewTB.setAttribute("id", "print-preview-toolbar");

    var navToolbox = getNavToolbox();
    navToolbox.parentNode.appendChild(printPreviewTB)
    //navToolbox.parentNode.insertBefore(printPreviewTB, navToolbox);
    //getBrowser().parentNode.insertBefore(printPreviewTB, getBrowser()); //LINEA ADJUNTA [2](l.197):
   ...
   *
   */
  init_pptoolbar: function (aEnterPPCallback, aExitPPCallback)
  {
    try
    {
      this._onEnterPP = aEnterPPCallback;
    ...
    {
         throw new Error('utilprint_mz'+('init_pptoolbar '+e));
    }
  },
  ...
  browserPreview: function ()
  {
    try
    {
        this.printPreview(onEnterPP, onExitPP);
    }
    catch(e)
    {
         throw new Error('utilprint_mz'+('browserPreview '+e));
    }
  },
  /**
   *
  ...
  closePreview: function ()
  {
    try
    {
        var win=getWindowBrowser();
        win.close();
    }
    catch(e)
    {
         throw new Error('utilprint_mz'+('closePreview '+e));
    }
  }
}
